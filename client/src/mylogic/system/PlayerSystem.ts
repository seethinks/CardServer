class PlayerSystem {
    ...
    private static initialInformation():PlayerInfo {
     ...
     *
     */
    public static getLevelUpExp(level:number = 0):number {
        return 1;
    }
     ...
     *
     */
    public static updatePlayerInfo(info:PlayerInfo):PlayerInfo {
     ...
     *
     */
    public static get selfPlayerInfo():PlayerInfo {
     ...
     * 删除所有玩家
     */
    public static removePlayers():void {
